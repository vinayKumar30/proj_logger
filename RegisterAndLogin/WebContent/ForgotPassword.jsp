...
<body
	...
	<form action="fp.do" method="post">
		<div class="container" style="height: 100%; align-content: center;">
			<div class="d-flex justify-content-center h-100">
				<div class="card"
					style="height: 250px; margin-top: auto; margin-bottom: auto; width: 400px; background-color: rgba(0, 0, 0, 0.5) !important;">
					<div class="card-header" style="color: white;">
						<h3>Enter Email Id to reset the password</h3>
	...
	<div align="center">
		<span style="font-family: cursive; color: white;">${message} ${password}</span> 
